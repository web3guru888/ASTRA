...
Analysis of 2\,000 SDSS galaxies revealed a bimodal distribution in rest-frame $u{-}g$ colour, with GMM-fitted peaks at $u{-}g = 1.44$ (blue cloud) and $u{-}g = 1.92$ (red sequence), confirming the broad bimodal colour structure of the galaxy population \citep{Baldry2004}. We note that \citet{Strateva2001} identified galaxy colour bimodality using $u^{*}{-}r^{*}$ (separator at $u^{*}{-}r^{*} = 2.22$), which is not directly comparable to our $u{-}g$ analysis.
