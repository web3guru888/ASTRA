...
$^{2}$VBRL Holdings Inc, 1309 Coffeen Avenue STE~1200, Sheridan, WY\,82801, USA}
...
\begin{itemize}
  \item 41 Active Galactic Nuclei (AGN), identified by high X-ray-to-optical flux ratios ($\log(f_X/f_\mathrm{opt}) > -1$) and hard X-ray spectra
