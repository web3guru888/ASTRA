...
inclination $\theta \approx 50^\circ$; \citealt{arzoumanian2019}), ASTRA predicts:
\begin{equation}
...
Applying the bias correction from equation~(\ref{eq:bias}), the predicted HGBS pairwise
median spacing for $n \approx 7$ cores is $2.08 \times 0.171 \approx 0.36$ pc. The
HGBS-reported pairwise median of $\approx 0.211$ pc for W3 filaments \citep{arzoumanian2019},
when corrected for pairwise median bias, yields a nearest-neighbour spacing of
$0.211/2.08 \approx 0.101$~pc $\approx \lambda_J$. This is consistent with field inclination
$\theta \lesssim 30^\circ$ ($\lambda_{J,m} \approx 1.2\,\lambda_J$) or an effectively higher
$\beta$ in the inter-core gas than in the dense filament spine---both physically plausible
geometries.
