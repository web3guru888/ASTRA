...
\begin{itemize}
\item We considered decaying turbulence; driven turbulence simulations may show different evolution
...
\item Self-gravity was not included in the MHD simulations, which may affect filament evolution at late times
\end{itemize}

Future work should include:
\begin{itemize}
\item Driven turbulence simulations to test steady-state filament properties
\item Inclusion of self-gravity to study filament fragmentation and core formation
