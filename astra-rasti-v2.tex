...
Beyond these controlled tests, live deployment on archival data independently recovers Kepler's third law ($R^{2}=0.9982$ from 2\,839 exoplanets), the observational signature of dark energy from 1\,701 Type~Ia supernovae, and galaxy colour bimodality from 2\,000 SDSS galaxies---results consistent with established physics and obtained without prior domain guidance.
...
\astra analysed 2\,839 confirmed exoplanets from the NASA Exoplanet Archive.
Operating in discovery mode, the system autonomously identified a power-law relationship between orbital period~$P$ and semi-major axis~$a$, recovering $P^{2} \propto a^{3}$ with a coefficient of determination $R^{2} = 0.9982$ and an exponent within 0.2\,per\,cent of the theoretical Keplerian value.
...
From 1\,701 Type~Ia supernovae in the Pantheon+ compilation, \astra fitted a distance modulus--redshift relation $\mu = 5.33\,\log(z) + 24.42$.
...
Analysis of 2\,000 SDSS galaxies revealed a bimodal distribution in rest-frame $u{-}g$ colour, with peaks at $u{-}g = 1.44$ (blue cloud) and $u{-}g = 1.92$ (red sequence).
